import { TriangleAlertIcon, SlidersHorizontal, CircleCheck, ChevronDown, Wrench, X } from "lucide-react";
                ...
                <>
                  {sortedSettings.map((g, i) => (
                    ...
                    >
                      ...
                      <div className="text-[11px] text-[#81818C] truncate">{g.description}</div>
                      </div>
                      <span
            ...
            <div className="flex-1 space-y-3 pt-0">
              <Card className="bg-[#101019] rounded-xl border border-[#14141e] pt-0">
                <CardContent className="px-5 pt-5 pb-3">
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center justify-between text-sm text-[#c6c6cf]">
                      ...
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.00008 8.66667L11.3334 6M9.33341 10C9.33341 10.7364 8.73648 11.3333 8.00008 11.3333C7.26368 11.3333 6.66675 10.7364 6.66675 10C6.66675 9.2636 7.26368 8.66667 8.00008 8.66667C8.73648 8.66667 9.33341 9.2636 9.33341 10Z" stroke="#81818C" stroke-width="1.25" stroke-linecap="round"/>
                        <path d="M4 8C4 5.79086 5.79086 4 8 4C8.7286 4 9.41167 4.19479 10 4.53513" stroke="#81818C" stroke-width="1.25" stroke-linecap="round"/>
                        <path d="M1.66675 8.00005C1.66675 5.01446 1.66675 3.52168 2.59424 2.59418C3.52174 1.66669 5.01452 1.66669 8.00011 1.66669C10.9856 1.66669 12.4784 1.66669 13.4059 2.59418C14.3334 3.52168 14.3334 5.01446 14.3334 8.00005C14.3334 10.9856 14.3334 12.4784 13.4059 13.4058C12.4784 14.3334 10.9856 14.3334 8.00011 14.3334C5.01452 14.3334 3.52174 14.3334 2.59424 13.4058C1.66675 12.4784 1.66675 10.9856 1.66675 8.00005Z" stroke="#81818C" stroke-width="1.25"/>
                        </svg>
                        High Performance
                      </span>
                      <input
                    ...
                    <label className="flex items-center justify-between text-sm text-[#81818C] opacity-60">
                      <span className="flex items-center gap-2">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.32426 6.32746L3.78466 5.00868C2.76924 4.13522 2.76584 2.86762 2.65747 2.013C3.76836 2.06572 4.62886 2.16629 5.37822 2.79929L6.16213 3.68991L7.01045 4.64235M12.9715 12.2787L10.9949 10.2788M9.34758 12.2787C9.36265 12.0972 9.48145 11.6267 10.0271 11.1226C10.5167 10.6702 11.5783 9.58625 12.0554 9.11618C12.3257 8.84991 12.7687 8.66311 12.9715 8.66345M10.3788 8.53871L11.2699 9.52458M9.11745 9.62418L10.1136 10.4999M13.641 11.9868C14.1946 11.9879 14.6673 12.3968 14.6663 12.95C14.6652 13.5032 14.1946 13.9883 13.641 13.9873C13.0874 13.9862 12.6605 13.4994 12.6615 12.9462C12.6973 12.3957 13.1045 12.0608 13.641 11.9868Z" stroke="#81818C" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M3.06404 12.262L5.03602 10.3338M3.04113 8.65809C3.22276 8.67282 3.72913 8.79408 4.18275 9.36075C4.59923 9.88095 5.72256 10.8871 6.19383 11.3629C6.46076 11.6325 6.64745 12.0594 6.64745 12.262M4.84308 9.48662L10.3358 3.10943C11.2296 2.11202 12.4787 2.09022 13.3358 1.99872C13.2613 3.10763 13.1437 3.96542 12.4957 4.70171L5.69981 10.6176M3.33754 12.9992C3.33754 13.5524 2.88876 14.001 2.33515 14.001C1.78155 14.001 1.33276 13.5524 1.33276 12.9992C1.33276 12.446 1.78155 11.9975 2.33515 11.9975C2.88876 11.9975 3.33754 12.446 3.33754 12.9992Z" stroke="#81818C" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Competitive
                      </span>
                      <input
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <button className="px-4 py-2 rounded-md bg-pink-600 text-[#0A0A14] text-sm w-[260px] h-[38px] cursor-pointer flex items-center justify-center gap-2">Apply <svg className="relative top-[1px]" width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12.1668 7H2.8335" stroke="#14141E" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M9.25006 9.91665C9.25006 9.91665 12.1667 7.76858 12.1667 6.99998C12.1667 6.23138 9.25 4.08331 9.25 4.08331" stroke="#14141E" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                    </button>
                    <button className="px-4 py-2 rounded-md bg-[#1A1A24] text-white text-sm w-[260px] h-[38px] cursor-pointer flex items-center justify-center gap-2">Revert to Default <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M6.91683 3.5H9.54183C10.9916 3.5 12.1668 4.67525 12.1668 6.125C12.1668 7.57476 10.9916 8.75 9.54183 8.75H2.8335" stroke="white" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M4.58348 7C4.58348 7 2.8335 8.28887 2.8335 8.75C2.83349 9.21118 4.5835 10.5 4.5835 10.5" stroke="white" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                    </button>
                  </div>
                  ...
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.5722 8.90449C12.7792 9.69735 11.2871 9.66655 8.99939 9.66655C7.52752 9.66655 6.33417 8.47142 6.33341 6.99955C6.33341 4.71336 6.30259 3.22045 7.09559 2.42761C7.88852 1.63477 8.23878 1.66687 11.7515 1.66687C12.091 1.66541 12.2619 2.07595 12.0219 2.31598L10.2132 4.12478C9.75412 4.5839 9.75285 5.32824 10.212 5.7873C10.6711 6.24637 11.4155 6.24641 11.8747 5.78741L13.6839 3.97905C13.9239 3.73908 14.3345 3.90991 14.3331 4.24932C14.3331 7.76149 14.3652 8.11169 13.5722 8.90449Z" stroke="white" stroke-width="1.5"/>
                    <path d="M9.00008 9.66667L4.88569 13.7811C4.14932 14.5174 2.95541 14.5174 2.21903 13.7811C1.48265 13.0447 1.48265 11.8507 2.21903 11.1144L6.33341 7" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                    <path d="M3.67272 12.3333H3.66675" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Additional Tweaks
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M16.5 9C16.5 4.85786 13.1421 1.5 9 1.5C4.85786 1.5 1.5 4.85786 1.5 9C1.5 13.1421 4.85786 16.5 9 16.5C13.1421 16.5 16.5 13.1421 16.5 9Z" stroke="#3B3B44" stroke-width="1.25"/>
                ...
                <div className="flex items-center gap-2 mt-5">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.33325 14H10.6666M9.33325 14C8.78099 14 8.33325 13.5522 8.33325 13V11.3333H7.99992M9.33325 14H6.66659M7.99992 11.3333H7.66659V13C7.66659 13.5522 7.21885 14 6.66659 14M7.99992 11.3333V14M6.66659 14H5.33325" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M10.6666 2H5.33325C3.44763 2 2.50483 2 1.91904 2.58579C1.33325 3.17157 1.33325 4.11438 1.33325 6V7.33333C1.33325 9.21893 1.33325 10.1617 1.91904 10.7475C2.50483 11.3333 3.44763 11.3333 5.33325 11.3333H10.6666C12.5522 11.3333 13.495 11.3333 14.0808 10.7475C14.6666 10.1617 14.6666 9.21893 14.6666 7.33333V6C14.6666 4.11438 14.6666 3.17157 14.0808 2.58579C13.495 2 12.5522 2 10.6666 2Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  <div className="text-white font-semibold text-lg">NVIDIA Control Panel Settings</div>
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.5 9C16.5 4.85786 13.1421 1.5 9 1.5C4.85786 1.5 1.5 4.85786 1.5 9C1.5 13.1421 4.85786 16.5 9 16.5C13.1421 16.5 16.5 13.1421 16.5 9Z" stroke="#3B3B44" stroke-width="1.25"/>
                    <path d="M9.18164 12.75V9C9.18164 8.64645 9.18164 8.46968 9.07177 8.3598C8.96197 8.25 8.78519 8.25 8.43164 8.25" stroke="#3B3B44" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M8.99414 6H9.00089" stroke="#3B3B44" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                      ...
                      {isEditingCustom ? (
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (Number.isFinite(v)) setCustomValue(Math.min(1, Math.max(0, v)));
                          }}
                          onBlur={() => setIsEditingCustom(false)}
                          onKeyDown={(e) => {
                            if (e.key === "Enter" || e.key === "Escape") setIsEditingCustom(false);
                          }}
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            className="flex-1
                                          ...
                                          cursor-pointer"
                            value={customValue}
                            onChange={(val) => setCustomValue(Array.isArray(val) ? val[0] : val)}
                                        maxValue={1}
                                        minValue={0}
                                        size="md"
                                        step={0.01}
