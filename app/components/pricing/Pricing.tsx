...
const Pricing: React.FC = () => {
    ...
    return (
        <div className="relative w-full h-full p-6 text-white">
            ...
            <h1 className="text-4xl text-center font-bold mb-3">Achieve <span className="bg-gradient-to-r from-[#FF2E79] via-[#818CF8] to-[#22D3EE] bg-clip-text text-transparent">maximum</span> performance</h1>
            ...
            >
                <CardContent className="p-6">
                    ...
                    <span className="text-[#FFFFFF] text-3xl font-medium">€9,99</span> <span className="text-gray-400 text-sm font-medium">/month</span>
                    <p className="text-gray-400 mb-8 mt-2">Billed monthly</p>
                    <Button className="text-center text-white bg-[##14141E] hover:bg-[#3a3a46] w-full rounded-[12px] border border-[#FF2E79]">Subscribe now</Button>
                    ...
                    <ul className="flex flex-col gap-2">
                        <li className="flex gap-2 items-center">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.33398 9.66675C3.33398 9.66675 4.33398 9.66675 5.66732 12.0001C5.66732 12.0001 9.37318 5.88897 12.6673 4.66675" stroke="#818CF8" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
            ...
            >
                <CardContent className="p-6">
                    ...
                    <div className="absolute top-6 right-6">
                        <button className="inline-flex items-center justify-center rounded-full bg-[#FF2E79] text-black text-xs font-semibold px-4 py-2 shadow-lg" onClick={() => setAnnualActive(v => !v)}>
                            Save 50%
                        </button>
                    </div>
                    <span className="text-[#FFFFFF] text-3xl font-medium">€5,99</span> <span className="text-gray-400 text-sm font-medium">/year</span>
            ...
            >
                <CardContent className="p-6">
                    ...
                    <span className="text-[#FFFFFF] text-3xl font-medium">€7,99</span> <span className="text-gray-400 text-sm font-medium">/quarterly</span>
