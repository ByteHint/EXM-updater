import { AlertCircleIcon, TriangleAlertIcon, SlidersHorizontal, CircleCheck, ChevronDown, Wrench, X } from "lucide-react";
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="w-full flex justify-center">
                    <button  onClick={() => setIsOpen(true)} className="flex items-center gap-2 bg-[#1A1A24] hover:bg-pink-600 text-white text-xs px-6 py-2 rounded-md transition cursor-pointer">
                      ...
                      >
                          {/* Popup Box */}
                          <div className="w-[380px] h-[488px] bg-[#14141E] text-white p-6 rounded-lg shadow-lg w-96">
                        <div className="flex items-center justify-between mb-4">
                          <h2 className="text-lg font-bold">Set System32 priority</h2>
                          <button
                            type="button"
                            aria-label="Close"
